      ...
      <div className="w-[50%] bg-[#1c1f20] absolute top-[10%] flex-col border-2 border-[#1545af] rounded-2xl ml-auto mr-auto">
        <div className="flex items-center flex-col gap-25px overflow-hidden">
          ...
          <div className="flex w-[40%] justify-between mt-5 mr-9.5">
            <button onClick={submitNotes} className="flex-none w-[27%] min-w-fit h-10 mt-5 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-[#1545af] dark:hover:bg-blue-800 focus:outline-none">Add Data</button>
