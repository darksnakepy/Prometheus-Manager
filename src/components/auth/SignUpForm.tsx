...
const SignUpForm = () =>{
    ...
    return(
        <div className="flex justify-center items-center w-full h-screen overflow-hidden">
          <div className="max-w-[450px] w-[90%] h-[550px] bg-[#1c1f20] top-[15%] flex-col border-2 border-[#1545af] rounded-2xl ml-auto mr-auto flex">                
          ...
          <h1 className="text-white text-[24px] font-bold mt-6">SIGN UP</h1>
          ...
          <input type="password" onChange={(e: ChangeEvent<HTMLInputElement>) => setMasterPass(e.target.value)} name="masterPass" placeholder="Create a master password" className="outline-none pl-[14px] bg-[#181a1b] mt-1.5 w-[60%] h-12 mb-[5%] rounded-[4px] placeholder:text-white/[0.6] placeholder:text-[14px] text-[14px] text-white "/>
          <input type="password" onChange={(e: ChangeEvent<HTMLInputElement>) => setRepeatPass(e.target.value)} name="phoneNumber" placeholder="Repeat master password " className="outline-none pl-[14px] bg-[#181a1b] mt-1.5 w-[60%] h-12 mb-[5%] rounded-[4px] placeholder:text-white/[0.6] placeholder:text-[14px] text-[14px] text-white " />
          ...
          <button className="w-[60%] h-[10%] mt-[3%] text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-[#1545af] dark:hover:bg-blue-800 focus:outline-none" onClick={submit}>Register</button>
          <div className="text-white mt-5 mb-3 text-[15px]">
