    ...
    return(
        <div className=""> {/* Main Container */}
            ...
            <div className="flex flex-col items-center justify-center h-screen">
                ...
                <button className="font-bold text-white text-[25px] bg-blue-700 hover:bg-blue-800 focus:ring-4 rounded-lg text-sm px-5 py-3.5 dark:bg-[#1545af] dark:hover:bg-blue-800 focus:outline-none mt-7 flex justify-start mr-[38%]" onClick={() => {router.push("/features")}}>Quickstart <GoArrowUpRight className="ml-1 mt-1"/></button> 
            </div>
